...
7. [对标分析：FA2 / FA3 / TE 与目标形状](content/posts/fa-bwd-07-analysis/index.md)
8. [性能调优历程与方法论](content/posts/fa-bwd-08-optimization-journey/index.md)
9. [目标卡移植注意事项](content/posts/fa-bwd-09-porting/index.md)

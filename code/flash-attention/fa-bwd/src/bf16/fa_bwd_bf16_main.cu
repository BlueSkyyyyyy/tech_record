// =============================================================================
// fa_bwd_bf16_main.cu —— FlashAttention 反向（bf16）**两文件版的 host 部分**
// =============================================================================
// 由单文件版 `fa_bwd_bf16_onefile.cu` 拆分而来（P2-2）：device 代码移入
// `fa_bwd_bf16_kernels.cuh`，本文件只保留 host 侧：npy 读取 / launcher / 自测对拍。
// 行为与单文件版**逐位一致**（kernel 代码逐字未改）。
//
// 用法：run.sh src/bf16/fa_bwd_bf16_main.cu [--dir=...] [--full|--causal] [--o=...] [--iters=N]
// =============================================================================

#include "fa_bwd_bf16_kernels.cuh"

...
| **MoE gate GEMM · 当前最佳** | **wgmma SS + TMA + mbarrier + warp specialization**（1 producer warp + 2/4 consumer WG） | **565.4 TFLOPS**@16k（128×128 s3）/ **600.3**@32k（256×128 s4） | **57.2% / 60.7%** (989) | cuBLAS bf16 734.6/752.6 → **77.0% / 79.8%**（1.30×/1.25×）；相对 27 篇 **2.80×/2.29×**；tensor pipe 68.2%、L2 79%、occ 26% | 28-moe-gate-wgmma |
